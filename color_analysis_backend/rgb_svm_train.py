...
# thư mục chứa feature RGB đã trích xuất
FEATURE_DIR = r"D:\NMAI\data\features\rgb"

# các file dữ liệu train/test cho bộ dữ liệu balanced/unbalanced
SETS = {
    "unbalanced": {
...
# hàm train SVM và đánh giá kết quả
def train_and_evaluate(name, paths):
    print(f"\nTRAIN RGB - {name.upper()}")
    ...
    # pipeline gồm chuẩn hóa dữ liệu và SVM RBF
    model = Pipeline([
        ("scaler", StandardScaler()),  # chuẩn hóa mean=0, std=1
